...
public class ProduktiService : IProduktiService
{
    ...
    public async Task<Response<Produkti>> CreateAsync(CreateProduktiDto produktiDto)
    {
        try
        {
            var produkti = new Produkti
            {
                ...
                Fotografia = produktiDto.Fotografia, // Already a string
    ...
    public async Task<Response<Produkti>> UpdateAsync(UpdateProduktiDto produktiDto)
    {
        try
        {
            var produkti = await _context.tblProdukti.FindAsync(produktiDto.Id);
            if (produkti == null)
                return new Response<Produkti>(null).NotFound("Produkti nuk u gjet.");
